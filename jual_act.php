...
mysqli_query($koneksi, "INSERT INTO produk VALUES ('','$idpenjual','','$penjual','$npenjual','$nama','$kategori','$harga','$keterangan','$jumlah','$berat','','','')");
...
header("location:customer_djual.php");