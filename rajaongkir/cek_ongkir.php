...
curl_setopt_array($curl_pos, array(
	...
	CURLOPT_HTTPHEADER => array(
		...
		"key: d98f47899260a0e8f08fe8d91c402060"
	),
));
	...
	<table class="table table-bordered">
		...
		?>
				<tr>
					...
					<td><?php echo "Rp. " . number_format($data_pos['rajaongkir']['results'][0]['costs'][$a]['cost'][0]['value']) . " ,-"; ?>
					</td>
		...
		?>
				<tr>
					...
					<td><?php echo "Rp. " . number_format($data_jne['rajaongkir']['results'][0]['costs'][$a]['cost'][0]['value']) . " ,-"; ?>
					</td>
		...
		?>
				<tr>
					...
					<td><?php echo "Rp. " . number_format($data_tiki['rajaongkir']['results'][0]['costs'][$a]['cost'][0]['value']) . " ,-"; ?>
					</td>
