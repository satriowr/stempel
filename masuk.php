...
<div id="breadcrumb">
	<div class="container">
		<ul class="breadcrumb">
			...
			<li class="active">Login Pelanggan</li>
		</ul>
	</div>
</div>
<!-- /BREADCRUMB -->
				...
				<div class="order-summary clearfix">
					...
					if(isset($_GET['alert'])){
						if($_GET['alert'] == "terdaftar"){
							echo "<div class='alert alert-success text-center'>Daftar akun berhasil</div>";
						...
						}elseif ($_GET['alert'] == "terverifikasi"){
							echo "<div class='alert alert-success text-center'>Email sudah terverifikasi, silahkan login</div>";
						}
					}
					?>
					<br>
					...
					<div class="row">
						<div class="col-lg-6 col-lg-offset-3">
							...
							<form action="masuk_act.php" method="post">
								...
								<div class="form-group">
									<input type="submit" class="primary-btn btn-block"  style="background: #54b4c2;" value="Login">
