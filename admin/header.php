...
<head>
    ...
    <title>Toko Stempel Kediri - Admin</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="index.php" class="logo" style="background:#54b4c2;">

                <span class="logo-lg" style="background:#54b4c2;"><b>Toko Stempel Kediri</span>
            </a>
            <nav class="navbar navbar-static-top" style="background:#54b4c2;">
                <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
                    <span class="sr-only">Toggle navigation</span>
                </a>

                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav" style="background:#54b4c2;">
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="fa fa-bell-o"></i>
                                <?php
                                $cek_notif = mysqli_query($koneksi, "SELECT * FROM notifikasi WHERE is_view = 0");
                                $rows = mysqli_num_rows($cek_notif);

                                ?>
                                <span class="label label-warning"><?= $rows ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <?php
                                        while ($yes = mysqli_fetch_array($cek_notif)) {
                                        ?>
                                            <li>
                                                <a href="rincian_pesanan.php?id=<?= $yes['invoice_id'] ?>&n=<?= $yes['id'] ?>">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php if ($_SESSION['role'] == 'admin') { ?>
                        ...
                        <li>
                            <a href="admin_pesan.php">
                                <i class="fa fa-dashboard"></i> <span>CHAT CUSTOMER</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="transaksi.php">
                                <i class="fa fa-retweet"></i> <span>DATA PESANAN</span>
                            </a>
                        </li>

                        <li>
                            <a href="history.php">
                                <i class="fa fa-retweet"></i> <span>RIWAYAT PESANAN</span>
                            </a>
                        </li>
                        <li>
                            <a href="laporan.php">
                        ...
                        <!-- <li>
                        <a href="web.php">
                            <i class="fa fa-lock"></i> <span>Template</span>
                        </a>
                    </li> -->
                    ...
                    <?php } else { ?>
                        ...
                        <li>
                            <a href="history.php">
                                <i class="fa fa-retweet"></i> <span>HISTORY / PESANAN</span>
                            </a>
                        </li>
