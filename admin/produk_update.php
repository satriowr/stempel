...
if ($insDataa == '') {
	mysqli_query($koneksi, "UPDATE produk set produk_nama='$nama', produk_kategori='$kategori', produk_harga='$harga', produk_keterangan='$keterangan', produk_berat='$berat', produk_jumlah='$jumlah', produk_stat = NULL, produk_catatan = NULL where produk_id='$id'");
} else {
	$insData = json_encode($insDataa);
	mysqli_query($koneksi, "UPDATE produk set produk_nama='$nama', produk_kategori='$kategori', produk_harga='$harga', produk_keterangan='$keterangan', produk_berat='$berat', produk_jumlah='$jumlah', produk_stat = NULL, produk_catatan = '$insData' where produk_id='$id'");
}
