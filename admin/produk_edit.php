            ...
            while($d = mysqli_fetch_array($data)){
              ?>
                        ...
                        <form action="produk_update.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" required="required"
                                    placeholder="Masukkan Nama .." value="<?php echo $d['produk_nama']; ?>">
                            </div>
                        ...
                        while($k = mysqli_fetch_array($kategori)){
                          ?>
                                            <option
                                                <?php if($k['kategori_id'] == $d['produk_kategori']){echo "selected='selected'";} ?>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" class="form-control textarea" required="required"
                                    style="resize: none" rows="10"><?php echo $d['produk_keterangan']; ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-info" type="button" id="addRow">Tambah</button>
                            </div>
                                ...
                                <div id="inputFormRow">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="catatan[]" class="form-control"
                                            placeholder="Masukan Catatan tambahan" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <?php } else {
                          $cats = json_decode($d['produk_catatan']);
                          foreach($cats as $item) { //foreach element in $arr//etc
                          ?>
                            <div class="form-group">
                                <div id="inputFormRow">
                                    <div class="row">
