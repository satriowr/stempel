...
if(isset($_GET['n'])){
    $idnotif = $_GET['n'];
    mysqli_query($koneksi, "UPDATE notifikasi SET is_view = 1 WHERE id = $idnotif");
}
           ...
           while($i = mysqli_fetch_array($invoice)){
            ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="transaksi.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>
                                KEMBALI</a>
                    ...
                    $no = 1;
                    $total = 0;
                    $transaksi = mysqli_query($koneksi,"SELECT * from transaksi,produk where transaksi_produk=produk_id and transaksi_invoice='$id_invoice' order by transaksi_produk");
                    while($d=mysqli_fetch_array($transaksi)){
                      ...
                      ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d['transaksi_catatan']; ?></td>
