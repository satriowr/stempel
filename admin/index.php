    ...
    <?php if($_SESSION['role'] == 'admin'){ ?>
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-aqua">
          ...
          <a href="transaksi.php" class="small-box-footer">Lihat Pesanan <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          ...
          <a href="produk.php" class="small-box-footer">Lihat Produk <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          ...
          <a href="customer.php" class="small-box-footer">Lihat Pelanggan <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
       <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          <div class="inner">
            <?php
            $customer = mysqli_query($koneksi,"SELECT SUM(invoice_total_bayar) AS totalpendapatan FROM invoice");
            $jumlah = mysqli_fetch_array($customer);
            ?>
            <h3>Rp. <?= number_format($jumlah['totalpendapatan'],0,",",".") ?></h3>
            <p>Total Pendapatan</p>
          </div>
          <a href="laporan.php" class="small-box-footer">Lihat Laporan <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
          ...
          <div class="box-body">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td>
                  <span class="label label-success text-uppercase"><?php echo $_SESSION['role']; ?></span>
                </td>
              </tr>
            </table>
          </div>
