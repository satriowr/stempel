            ...
            <form method="get" action="">
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <br/>
                    <input type="submit" style="background:#54b4c2;" value="TAMPILKAN LAPORAN" class="btn btn-sm btn-primary">
                  </div>
                </div>
              ...
              <div class="table-responsive" >
                <table class="table table-bordered table-striped" id="table-datatable" >
                  ...
                  <tbody>
                    <?php 
                    $no=1;
                    $qTotal = mysqli_query($koneksi, "SELECT SUM(invoice_total_bayar) as total_pembayaran FROM invoice,customer WHERE invoice_customer=customer_id and date(invoice_tanggal) >= '$tgl_dari' AND date(invoice_tanggal) <= '$tgl_sampai'");
