...
$login = mysqli_query($koneksi, "SELECT * FROM customer WHERE customer_email='$email' AND customer_password='$password' AND aktif='1'");
...
if ($cek > 0) {
	...
	$_SESSION['unique_id'] = $data['customer_id'];
