  ...
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        <h2><b>DASHBOARD ADMIN <br>Stempel Kediri</b></br></h2>
        <br/>
        ...
        <form action="periksa_login.php" method="POST">
          ...
          <div class="row">
            <div class="col-xs-offset-8 col-xs-4" >
              <button type="submit" class="btn btn-primary btn-block btn-flat" style="background: #54b4c2;" >LOGIN</button>
            </div>
          </div>
        </form>
