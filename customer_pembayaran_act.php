...
if(in_array($ext,$allowed) ) {
	...
	mysqli_query($koneksi,"UPDATE invoice set invoice_transaksi = '$id_transaksi', invoice_bukti='$file_gambar', invoice_status='1' where invoice_id='$id'")or die(mysqli_error($koneksi));
