                            ...
                            <tbody>
                    			...
                    			<?= $cats ?>
                                    ...
                                    <td class="qty text-center">
                                        ...
                                        <input name="catatan[]" value="<?php echo $_SESSION['keranjang'][$a]['catatan']; ?>" type="hidden">
                                        <input class="input jumlah" name="jumlah[]"
                                            id="jumlah_<?php echo $i['produk_id'] ?>"
                                            nomor="<?php echo $i['produk_id'] ?>" readonly type="text"
                                            value="<?php echo $_SESSION['keranjang'][$a]['jumlah']; ?>" min="1">

                                            <a class="main-btn icon-btn"
                                            href="produk_detail.php?id=<?php echo $i['produk_id'] ?>"><i
